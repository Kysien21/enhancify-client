  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        alert(response.data.message || "Password has been reset successfully! You can now login with your new password.");
      ...
      if (err.response?.status === 400) {
        ...
        // If token expired, redirect to forgot password after 3 seconds
        setTimeout(() => {
          navigate("/forgot-password");
        }, 3000);
